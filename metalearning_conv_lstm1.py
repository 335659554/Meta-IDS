...
class LSTM_RNN(nn.Module):
    def __init__(self):
        ...
        self.lstm = nn.LSTM((feature_num+2*1-3)+1, feature_num * 2, num_layers=1, batch_first=True)
...
if __name__ == '__main__':
    ...
    with torch.backends.cudnn.flags(enabled=False):
        ...
        for epoch in range(epoch_num):
            ...
            print('--------------------------------------------')
            print('--------------------------------------------')
            torch.save(meta_model, 'convlstm1le' + str(epoch_num) + 'v2.pth')
