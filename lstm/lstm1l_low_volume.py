...
class LSTM_RNN(nn.Module):
    def __init__(self):
        ...
        self.lstm = nn.LSTM(11, 11 * 2, num_layers=1, batch_first=True)
        self.norm = nn.BatchNorm1d(11 * 2)
        self.linear1 = nn.Linear(11 * 2, 11)
        self.relu1 = nn.ReLU()
        self.linear2 = nn.Linear(11, math.ceil(11 / 2))
        self.relu2 = nn.ReLU()
        self.linear3 = nn.Linear(math.ceil(11 / 2), 2)
...
if __name__ == '__main__':
    ...
    for i in range(1, extract_num + 1):
        ...
        test_loader = torch.utils.data.DataLoader(dataset=task_dataset, batch_size=65536)
